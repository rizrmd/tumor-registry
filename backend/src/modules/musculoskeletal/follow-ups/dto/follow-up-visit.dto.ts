...
export class FollowUpVisitDto {
  ...
  @ApiPropertyOptional({ description: 'Dokter Pemeriksa (Examining doctor)' })
  examinedBy?: string;

  @ApiPropertyOptional({ description: 'Keluhan (Chief complaint)' })
  chiefComplaint?: string;

  @ApiPropertyOptional({ description: 'Pemeriksaan Fisik (Physical examination)' })
  physicalExamination?: string;

  @ApiPropertyOptional({ description: 'Pemeriksaan Penunjang (Supporting examination summary)' })
