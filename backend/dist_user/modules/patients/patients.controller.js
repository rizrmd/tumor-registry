...
let PatientsController = class PatientsController {
    ...
    async findAll(centerId, search, includeInactive, page, limit, req) {
        return await this.patientsService.findAll(centerId, includeInactive === 'true', page ? parseInt(page) : 1, limit ? parseInt(limit) : 50, search, req?.user);
    }
    ...
    async findByMRN(mrn) {
        return await this.patientsService.findByHospitalRecordNumber(mrn);
    }
    ...
    async sendChatMessage(sessionId, body) {
        return await this.patientsService.sendChatMessage(sessionId, body.content, body.fieldName, body.formData);
    }
