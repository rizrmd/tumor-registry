...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('CREATE', 'role'),
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('UPDATE', 'role'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Role not found' }),
    (0, permissions_decorator_1.RequirePermissions)('ROLES_UPDATE'),
    (0, audit_log_decorator_1.AuditLog)('UPDATE', 'role_permissions'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('DELETE', 'role'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
