...
exports.PatientsModule = PatientsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [patients_service_1.PatientsService, medical_record_service_1.MedicalRecordService],
        exports: [patients_service_1.PatientsService, medical_record_service_1.MedicalRecordService],
    })
], PatientsModule);
