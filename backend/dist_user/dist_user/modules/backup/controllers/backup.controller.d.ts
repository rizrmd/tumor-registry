...
export declare class BackupController {
    ...
    toggleBackupJob(id: string): Promise<void>;
    ...
    verifyBackup(executionId: string): Promise<any>;
    getStorageConfigurations(): Promise<void>;
    addStorageConfiguration(storageConfig: any): Promise<void>;
    getBackupTemplates(): Promise<void>;
