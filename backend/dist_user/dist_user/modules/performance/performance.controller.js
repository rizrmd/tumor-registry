...
let PerformanceController = class PerformanceController {
    ...
    async streamPatients(reply, centerId, format = 'json') {
        try {
            ...
            if (format === 'csv') {
                const csvStream = this.streamingService.createCsvStream(stream, ['id', 'hospitalRecordNumber', 'name', 'dateOfBirth', 'gender', 'province', 'createdAt'], (patient) => [
                    patient.id,
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('IMPLEMENT', 'caching_strategy'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('PERFORMANCE_OPTIMIZE'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    (0, audit_log_decorator_1.AuditLog)('OPTIMIZE', 'performance'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    (0, audit_log_decorator_1.AuditLog)('RUN', 'performance_benchmark'),
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('CLEAR', 'cache'),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, audit_log_decorator_1.AuditLog)('MAINTAIN', 'database'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('PERFORMANCE_OPTIMIZE'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    (0, audit_log_decorator_1.AuditLog)('WARM', 'cache'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
