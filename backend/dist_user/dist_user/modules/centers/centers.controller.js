...
let CentersController = class CentersController {
    ...
    async getMyRemoteDbConfig(req) {
        const centerId = req.user.centerId;
        if (!centerId) {
            throw new common_1.ForbiddenException('User has no center assigned');
        }
    ...
    async updateRemoteDbConfig(id, configDto) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all centers (Public - no auth required)' }),
...
__decorate([
    (0, common_1.Get)('my/remote-db-config'),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Get remote database config for current user center (Desktop)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Remote DB config retrieved successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'User has no center assigned' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'No remote DB config found for center' }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CentersController.prototype, "getMyRemoteDbConfig", null);
__decorate([
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get center by ID (Public - no auth required)' }),
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('CREATE', 'center'),
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('UPDATE', 'center'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Center not found' }),
    (0, permissions_decorator_1.RequirePermissions)('CENTERS_UPDATE'),
    (0, audit_log_decorator_1.AuditLog)('ACTIVATE', 'center'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('CENTERS_UPDATE'),
    (0, audit_log_decorator_1.AuditLog)('DEACTIVATE', 'center'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, audit_log_decorator_1.AuditLog)('DELETE', 'center'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Put)(':id/remote-db-config'),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Update remote database config for a center (Admin)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Center ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Remote DB config updated successfully' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Center not found' }),
    (0, permissions_decorator_1.RequirePermissions)('CENTERS_UPDATE'),
    (0, audit_log_decorator_1.AuditLog)('UPDATE', 'center_remote_config'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], CentersController.prototype, "updateRemoteDbConfig", null);
