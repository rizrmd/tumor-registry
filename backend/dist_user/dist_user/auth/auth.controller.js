...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Email not found or already verified' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)('test-roles'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, roles_decorator_1.Roles)('admin', 'national_stakeholder'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Test role-based access' }),
...
], AuthController.prototype, "testRoles", null);
