...
let FrontendController = class FrontendController {
    serveIndex(res) {
        const indexPath = (0, path_1.join)(process.cwd(), 'frontend', 'index.html');
        return res.sendFile(indexPath);
    }
    serveHealthIndex(res) {
        const indexPath = (0, path_1.join)(process.cwd(), 'frontend', 'index.html');
        return res.sendFile(indexPath);
    }
    serveSpa(res) {
...
], FrontendController.prototype, "serveIndex", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], FrontendController.prototype, "serveHealthIndex", null);
__decorate([
    (0, common_1.Get)('*'),
    __param(0, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], FrontendController.prototype, "serveSpa", null);
