...
export default function FollowUpCompliancePage() {
  ...
  return (
    <Layout>
      ...
      {/* Importance Notice */}
      <div className="bg-emerald-50 border-l-4 border-emerald-400 rounded-lg p-4 mb-6">
        <div className="flex gap-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-emerald-900 mb-1">
              Pentingnya Compliance Tracking
            </h4>
            <p className="text-sm text-emerald-800">
              Monitoring kepatuhan follow-up sangat krusial untuk <strong>deteksi dini rekurensi tumor</strong>, <strong>evaluasi efektivitas pengobatan</strong>,
              dan <strong>menjaga validitas data penelitian</strong>. Compliance rate yang tinggi (&gt;90%) memastikan data registry berkualitas tinggi
              dan dapat digunakan untuk publikasi internasional serta perbaikan protokol klinis.
            </p>
          </div>
        </div>
      </div>
