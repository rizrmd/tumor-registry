  ...
  const filterVisits = () => {
    ...
    if (searchQuery) {
      filtered = filtered.filter(v =>
        ...
        v.patient?.inamsosRecordNumber?.toLowerCase().includes(searchQuery.toLowerCase()) ||
        v.patient?.hospitalRecordNumber?.toLowerCase().includes(searchQuery.toLowerCase())
      );
    }
                  ...
                  <tr key={visit.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {visit.patient?.inamsosRecordNumber || visit.patient?.hospitalRecordNumber || '-'}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
