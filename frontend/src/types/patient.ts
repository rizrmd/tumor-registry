...
export interface PatientSearchDto {
  ...
  // Privacy-compliant search fields (NO name search)
  anonymousId?: string;
  ...
  page?: number;
  limit?: number;
  sortBy?: 'anonymousId' | 'inamsosRecordNumber' | 'createdAt' | 'dateOfDiagnosis' | 'lastVisitDate';
  sortOrder?: 'asc' | 'desc';
}
...
export interface QuickPatientEntry {
  // NO name field - privacy compliant
  // anonymousId and inamsosRecordNumber auto-generated by backend
  ...
  treatmentCenter: string; // Required for MR number generation
}
