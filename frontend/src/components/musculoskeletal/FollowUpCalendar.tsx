              ...
              <div className="text-sm text-purple-700 mt-2">
                <div className="mb-2">
                  ...
                  <div className="ml-4 text-xs mt-1">
                    Visit 1-8: 3, 6, 9, 12, 15, 18, 21, 24 months post-treatment
                  </div>
                </div>
                <div>
                  <strong>Year 3-5 (Every 6 months):</strong>
                  <div className="ml-4 text-xs mt-1">
                    Visit 9-14: 30, 36, 42, 48, 54, 60 months post-treatment
                  </div>
                </div>
              </div>
              <p className="text-xs text-purple-600 mt-2 italic">
                Per dokumen resmi: Indonesian Musculoskeletal Tumor Registry
              </p>
            </div>
          </div>
        </div>
