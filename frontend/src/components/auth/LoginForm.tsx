    ...
    <div className="w-full space-y-4">
      <div>
        <div className="flex justify-center">
          <div className={`w-12 h-12 rounded-lg flex items-center justify-center animate-pulse ${isBackendReady ? 'bg-emerald-600' : 'bg-red-600'
            }`}>
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          <button
            ...
            className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-lg text-white ${isBackendReady ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-gray-600 hover:bg-gray-700'
