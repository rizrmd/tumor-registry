...
interface MedicalImageUploaderProps {
  ...
  recordId?: string; // Optional: Link to a specific record (e.g., Follow-up Visit ID)
}
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-6">
        ...
        <div
          className={`border-2 border-dashed rounded-lg p-8 text-center ${selectedFile ? 'border-green-400 bg-green-50' : 'border-gray-300 bg-gray-50'
            }`}
        >
          <input
            ref={fileInputRef}
          ...
          >
            <svg
              className={`w-16 h-16 mb-4 ${selectedFile ? 'text-green-500' : 'text-gray-400'
                }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
      ...
      <div className="flex gap-4">
        <button
          ...
          className={`flex-1 px-6 py-3 rounded-lg font-semibold transition-colors ${!selectedFile || uploading
