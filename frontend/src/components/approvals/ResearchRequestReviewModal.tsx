        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 z-10">
          ...
          <div className="flex border-b border-gray-200">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium ${activeTab === 'data-fields'
                  ? 'border-b-2 border-blue-600 text-blue-600'
                  : 'text-gray-500 hover:text-gray-700'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium ${activeTab === 'ethics'
                  ? 'border-b-2 border-blue-600 text-blue-600'
                  : 'text-gray-500 hover:text-gray-700'
                }`}
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button
                ...
                className={`px-4 py-3 rounded-lg border-2 font-medium transition-all ${decision === 'APPROVE'
              ...
              <button
                ...
                className={`px-4 py-3 rounded-lg border-2 font-medium transition-all ${decision === 'APPROVE_WITH_CONDITIONS'
              ...
              <button
                ...
                className={`px-4 py-3 rounded-lg border-2 font-medium transition-all ${decision === 'REQUEST_MORE_INFO'
              ...
              <button
                ...
                className={`px-4 py-3 rounded-lg border-2 font-medium transition-all ${decision === 'REJECT'
