...
export default function PatientList({
  ...
  const { setCurrentPatient, loadMorePatients } = usePatient();
      ...
      <div className="divide-y divide-gray-200">
        {patients.map((patient) => (
          <div
            ...
            className={`p-6 hover:bg-gray-50 cursor-pointer transition-colors ${selectedId === patient.id ? 'bg-blue-50' : ''
              }`}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                {/* Patient Avatar - Using gender icon instead of name initials */}
                ...
                {/* Patient Info - Display anonymousId instead of name */}
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    <h4 className="text-lg font-mono font-semibold text-blue-600">
                      {patient.anonymousId}
                    </h4>
                    {patient.isDeceased && (
