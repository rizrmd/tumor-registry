...
// Per INAMSOS official document: Year 1-2 every 3 months, Year 3-5 every 6 months
      ...
      {currentVisit && (
        <div className="bg-gradient-to-br from-indigo-50 to-white rounded-lg border-2 border-indigo-200 p-6">
          ...
          <div className="space-y-6">
            ...
            {/* Dokter Pemeriksa (Required per document) */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            {/* Pemeriksaan Penunjang (Supporting Examination Summary) */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <p className="text-xs text-gray-500 mt-1">
                ...
                Detail imaging dan lab tetap dapat dicatat di field khusus di bawah.
              </p>
            </div>
