 ...
 * - File Uploads for Radiology (X-Ray, MRI, etc) and Pathology
 */
import { RadiologyModalities, PathologyFiles } from '../subsections';
...
interface Section4Data {
  ...
  radiologyModalities?: any[]; // Using any[] to avoid circular dependency, typed in components
  pathologyFiles?: any[];      // Using any[] to avoid circular dependency
}
...
export function Section4DiagnosticInvestigations() {
  ...
  const sectionData: Section4Data = {
    ...
    radiologyModalities: savedData.radiologyModalities || [],
    pathologyFiles: savedData.pathologyFiles || [],
  };
