      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.hospitalRecordNumber}
              onChange={(e) => updateFormData('hospitalRecordNumber', e.target.value)}
              placeholder="MR-2025-00001"
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.hospitalRecordNumber ? 'border-red-500' : 'border-gray-300'
                }`}
            />
            {errors.hospitalRecordNumber && (
              <p className="mt-1 text-sm text-red-500">{errors.hospitalRecordNumber}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={16}
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.nik ? 'border-red-500' : 'border-gray-300'
              }`}
          />
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.dateOfBirth ? 'border-red-500' : 'border-gray-300'
                }`}
            />
            {errors.dateOfBirth && (
        ...
        <div>
          ...
          <div className="flex space-x-4">
            {GENDERS.map((gender) => (
              <label
                key={gender.value}
                className={`flex items-center px-6 py-3 border-2 rounded-lg cursor-pointer transition-all ${formData.gender === gender.value
